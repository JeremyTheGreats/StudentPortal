...
public class admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_welcome, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 317, 283, 47));

        lbl_role.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        lbl_role.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_role.setText("jLabel1");
        getContentPane().add(lbl_role, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 283, 38));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/ad.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(58, 111, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Student User");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 76, 128, 46));

        student.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        getContentPane().add(student, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 120, 91, 66));
        ...
        getContentPane().add(manageuser, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 290, 138, 35));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 330, 170, 50));
